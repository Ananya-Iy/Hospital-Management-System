...
$today_revenue = $conn->query("SELECT COALESCE(SUM(paid_amount), 0) as total FROM invoices WHERE DATE(created_at) = CURDATE()")->fetch_assoc()['total'];

$todays_appointments = [];
$apt_result = $conn->query(
    "SELECT a.*, u.name as patient_name, d.user_id as doc_user_id, du.name as doctor_name, s.name as specialization
     FROM appointments a
...
$patient_result = $conn->query(
    "SELECT p.id, u.name, u.email, u.phone, p.date_of_birth, p.gender, p.blood_group, p.created_at
     FROM patients p
     JOIN users u ON p.user_id = u.id
...
<head>
    ...
    <title>Receptionist Portal · Valora Medical Center</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-section">
            <div class="welcome-text">
                <h1>Welcome back, <?php echo htmlspecialchars($receptionist_name); ?>! 👋</h1>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <p>Today's Revenue</p>
                    <h3>BD <?php echo number_format($today_revenue, 2); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="quick-actions">
            <a href="register-patient.php" class="quick-card">
                <i class="fas fa-user-plus"></i>
                <span>Register Patient</span>
            </a>
            <a href="manage-appointments.php" class="quick-card">
                <i class="fas fa-calendar-alt"></i>
                <span>Manage Appointments</span>
            </a>
            <a href="manage-appointments.php#book" class="quick-card">
                <i class="fas fa-calendar-plus"></i>
                <span>Book Appointment</span>
            </a>
            <a href="manage-appointments.php#invoices" class="quick-card">
        ...
        <div class="section-heading">
            ...
            <a href="register-patient.php">Register new →</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span style="color: var(--n6); font-size: 0.85rem;"><?php echo htmlspecialchars($patient['phone'] ?? 'N/A'); ?></span>
                        </td>
